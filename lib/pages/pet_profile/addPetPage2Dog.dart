...
class addPetPage2Dog extends StatefulWidget {
  @override
  _addPetPage2DogState createState() => _addPetPage2DogState();
}

class _addPetPage2DogState extends State<addPetPage2Dog> {
  ...
  List<String> _breeds = ['Labrador', 'German Shepherd', 'Akita', 'Pekingese', 'Another']; //list of dogs breeds available in the aplication
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Fill in data about your dog"),
        centerTitle: true,
                ...
                onPressed: () async {                //want create pet's profil
                  ...
                  if(image_path.toString() == ''){
                    await showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            content: Text('Please add image of dog'),
                            actions: [
                              TextButton(
                                  onPressed: () {Navigator.pop(context);},
                                  child: Text("OK")
                  ...
                  int i = await DatabaseHelper.instance.insert('Dog',{
                    'name' : nameController,
